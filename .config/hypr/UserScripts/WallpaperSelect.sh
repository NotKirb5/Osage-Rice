...
focused_monitor=$(hyprctl monitors -j | jq -r '.[].name')
...
# Rofi command
rofi_command="rofi -i -show -dmenu -config $rofi_theme -theme-str "
...
apply_image_wallpaper() {
  ...
  for monitor in $focused_monitor; do
